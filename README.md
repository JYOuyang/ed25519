...
interoperate with ed25519 keys generated by Peters' original library, which
used a private key representation derivative of the seed but not reversible to
it, and whose keys are incompatible with most other ed25519 libraries
(including all known Python implementations).
